...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2023 a las 18:55:06
...
INSERT INTO `citas` (`id`, `id_doctor`, `id_consultorio`, `id_paciente`, `nyaP`, `documento`, `inicio`, `fin`, `alergias`, `patologias`, `diagnostico`, `estado`) VALUES
(1, 1, 15, 33, 'UsuarioTestNF Test1', '1548753852', '2023-01-16 10:00:00', '2023-01-16 11:00:00', 'Frio, viento, polen', 'Sarampion, paperas, tuberculosis', 'defensas bajas', 'Atendida'),
...
(82, 1, 15, 8, 'Paciente N Arteaga', '1254789658', '2023-01-11 12:00:00', '2023-01-11 13:00:00', 'Al calor, al frio, al pole, lacteos, gluten', 'Enrojecimiento del cuerpo, gripe, tos, dolor de cabeza, congestion nasal, dolor corporal,  diarrea y vomito.', 'Posible infeccion estomacal, se debe controlar con antibioticos para la infeccion y antigripal para eviarposibes efectos de gripe estacionaria.', 'Atendida'),
...
(101, 1, 15, 6, 'Edgar Paciente Burbano', '1475236504', '2023-01-09 14:00:00', '2023-01-09 15:00:00', '', '', '', 'Atendida'),
(102, 1, 15, 6, 'Edgar Paciente Burbano', '1475236504', '2023-01-12 13:00:00', '2023-01-12 14:00:00', 'frio', 'Hambre', 'Desnutrido', 'Atendida'),
...
(194, 1, 15, 20, 'Alex Usuario B', '1548726345', '2023-01-24 11:00:00', '2023-01-24 12:00:00', 'No refiere', 'Gripe, perdida deolfato, irritacion en las mucosas', 'Covid', 'Atendida'),
(195, 1, 15, 20, 'Alex Usuario B', '1548726345', '2023-10-25 10:00:00', '2023-10-25 11:00:00', 'No refiere', 'Sarpullido, vomito, diarrea', 'Dengue', 'Atendida'),
...
(203, 6, 1, 26, 'PuebaAP PruebaAPCU1', '1587252145', '2023-02-20 08:00:00', '2023-02-20 09:00:00', '', '', '', 'Reservada'),
(204, 6, 1, 26, 'PuebaAP PruebaAPCU1', '1587252145', '2023-02-20 08:00:00', '2023-02-20 09:00:00', '', '', '', 'Reservada'),
(205, 6, 1, 26, 'PuebaAP PruebaAPCU1', '1587252145', '2023-02-28 09:00:00', '2023-02-28 10:00:00', '', '', '', 'Reservada'),
(206, 1, 15, 32, 'Paciente 32 Prueba', '17201689093215', '2023-02-22 10:00:00', '2023-02-22 11:00:00', 'Polen, frio, agua salada', 'resfrio', 'gripe', 'Atendida'),
(207, 1, 15, 32, 'Paciente 32 Prueba', '17201689093215', '2023-02-22 14:00:00', '2023-02-22 15:00:00', 'fs', 'dsfds', 'fdsfsd', 'Atendida'),
(208, 1, 15, 31, 'Paciebte testApelli', '1548732615', '2023-02-22 13:00:00', '2023-02-22 14:00:00', 'No registra', 'Fiebre, tos, dolor de cabez', 'Covid', 'Atendida'),
(209, 1, 15, 31, 'Paciebte testApelli', '1548732615', '2023-02-23 10:00:00', '2023-02-23 11:00:00', '', '', '', 'Reservada'),
(210, 1, 15, 31, 'Paciebte testApelli', '1548732615', '2023-02-23 10:00:00', '2023-02-23 11:00:00', '', '', '', 'Reservada'),
(211, 0, 15, 0, 'adoctora a', 'a', '2023-03-08 13:00:00', '2023-03-08 14:00:00', '', '', '', 'Reservada'),
(212, 0, 15, 0, 'adoctora a', 'a', '2023-03-14 13:00:00', '2023-03-14 14:00:00', '', '', '', 'Reservada'),
(213, 1, 15, 0, 'adoctora a', 'a', '2023-03-10 12:00:00', '2023-03-10 13:00:00', '', '', '', 'Reservada'),
(214, 6, 1, 5, 'Paciente AAlexander', '1720604807', '2023-03-10 10:00:00', '2023-03-10 11:00:00', '', '', '', 'Reservada'),
(215, 3, 5, 5, 'Paciente AAlexander', '1720604807', '2023-03-10 09:00:00', '2023-03-10 10:00:00', 'polen y al frio', 'dolor de cabeza, problemas respiratorios', 'Alergia comun, se recomienda  loratadina de 1M cada 8 horas por 5 días o hasta q la muerte nos separe', 'Atendida');
...
(1, 15, 'Estrada', 'DOCTORA', 'Vistas/img/Doctores/Doc-976.jpg', 'doc', 'tor1', 'Femenino', '1750468909', 'doc@test1.com', '+593 992 542 55', 'La america 326 y Test1', 'Seleccionar...', '1987-07-24', '10:00:00', '17:00:00', 'Doctor'),
...
(0, 'adoctor', 'apaciente', 'ab', 'adoctor@a.com', 'ab', 'a', 'Quito', '2020-03-05', 'Masculino', '', 'aa', 'a', 'Paciente'),
...
(5, 'AAlexander', 'Paciente', '1720604807', 'nuevo@correo.com', '+593652541570', 'Obelisco', 'Quito', '2022-03-07', 'Masculino', '', 'paci', 'ente', 'Paciente'),
...
--
-- Estructura de tabla para la tabla `preexistente`
--

CREATE TABLE `preexistente` (
  `id` int(11) NOT NULL,
  `nombre` text NOT NULL,
...
--
-- Volcado de datos para la tabla `preexistente`
--

INSERT INTO `preexistente` (`id`, `nombre`, `idpaciente`) VALUES
(1, 'Sarampión25', 26),
(2, 'Varicela nueva cepa', 26),
(3, 'tifoidea', 26),
(4, 'Nueva enfermedad para eliminar', 26);
...
INSERT INTO `recetas` (`id_receta`, `id_cita`, `producto`, `cantidad`, `fechareceta`, `indicaciones`) VALUES
(1, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(2, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(3, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(4, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(5, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(6, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(7, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(8, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(9, 195, 'Ibuprofeno de 400mg', '15', '2023-02-22', 'Tomar cada 8 horas después de cada comida '),
(10, 195, 'Analgan u otro analgesico con al menos 400 mg', '4', '2023-02-22', 'Cada 12 horas por 2 dias'),
(11, 195, 'Analgan u otro analgesico con al menos 400 mg', '4', '2023-02-22', 'Cada 12 horas por 2 dias'),
(12, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(13, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(14, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(15, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(16, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(17, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(18, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(19, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(20, 195, 'sda', 'dsa', '2023-02-22', 'dsa'),
(21, 195, 'sda', 'dsa', '2023-02-22', 'dsa');
...
--
-- Indices de la tabla `preexistente`
--
ALTER TABLE `preexistente`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `preexistente`
--
ALTER TABLE `preexistente`
